...
class Student:
    def __init__(self,root):
        ...
        img30 = Image.open("college_images/AdobeStock_303989091.jpeg")
        ...
        img20 = Image.open("college_images/gettyimages-1022573162.jpg")
    ...
    def add_data(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_roll.get()=="" or self.usertype.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="127.0.0.1",username="root",password="Sejal@oracle1",database="fac='facee_recognition_recognition")
    ...
    def search_data(self):
        if self.serchTxt_var.get()=="" or self.serch_var.get()=="Select Option":
            ...
            try:
                conn=mysql.connector.connect(host='',username='root',password='Sejal@oracle1',database='facee_recognition')
                my_cursor=conn.cursor()
